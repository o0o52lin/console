...
use Workerman\GatewayWorker\Gateway as WGateway;
use Workerman\Autoloader;
use Workerman\Config\Gateway;

// gateway 进程，这里使用Text协议，可以用telnet测试
$gateway = new WGateway(Gateway::$protocol.'://'.Gateway::$address.':'.Gateway::$port);
// gateway名称，status方便查看
$gateway->name = Gateway::$worker_name;
// gateway进程数
$gateway->count = Gateway::$worker_count;
// 本机ip，分布式部署时使用内网ip
$gateway->lanIp = Gateway::$address;
// 内部通讯起始端口，假如$gateway->count=4，起始端口为4000
// 则一般会使用4000 4001 4002 4003 4个端口作为内部通讯端口 
$gateway->startPort = Gateway::$inner_start_port;
// 服务注册地址
$gateway->registerAddress = Gateway::$register_address.':'.Gateway::$register_port;
// 设置路由到指定进程
