...
namespace Workerman\Business\GlobalData;
...
class Server
{
    ...
    protected function saveCache()
    {
        ...
        if(is_file($this->datapath) && is_writable($this->datapath)){
            ...
            $cache_string .= '$data = '.var_export(is_array($this->_dataArray) ? $this->_dataArray : [], true).';'.PHP_EOL;
            $cache_string .= '$expire = '.var_export(is_array($this->_expireArray) ? $this->_expireArray : [], true).';'.PHP_EOL;
